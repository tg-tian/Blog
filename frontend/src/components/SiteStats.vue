    ...
    <div v-else>
      ...
      <div class="text-center">
        <button
          @click="handleLike"
          :disabled="isLiking"
          class="inline-flex items-center px-3 py-1.5 bg-gray-800 hover:bg-gray-900 text-white text-caption font-medium rounded-lg transform hover:scale-105 transition-all duration-200 shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
        >
          <svg
