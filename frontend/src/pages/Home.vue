<template>
  <div class="home-container">
    ...
    <div class="hero-section relative h-screen overflow-hidden">
      ...
      <div class="absolute bottom-16 right-8 z-10 text-right text-white px-4 animate-fade-in-up">
        <h1
          ...
          style="font-family: 'KaiTi', 'SimSun', serif"
        >
          浴乎沂，风乎舞雩，咏而归
        </h1>
        <p class="mt-2 text-sm md:text-base opacity-60">—— 论语 · 先进</p>
      </div>
    ...
    <div
      id="content-section"
      class="flex flex-col min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 antialiased"
    >
      <NavBar />
  ...
  const handleScroll = () => {
    ...
    if (navbar) {
      ...
      navbar.style.boxShadow =
        navOpacity.value > 0
          ? `0 1px 3px 0 rgba(0, 0, 0, ${navOpacity.value * 0.1}), 0 1px 2px 0 rgba(0, 0, 0, ${navOpacity.value * 0.06})`
          : 'none'
      navbar.style.borderBottom =
        navOpacity.value > 0 ? `1px solid rgba(229, 231, 235, ${navOpacity.value})` : 'none'
    }
  }
